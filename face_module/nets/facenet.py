...
from face_module.nets.inception_resnetv1 import InceptionResnetV1
from face_module.nets.mobilenet import MobileNetV1
...
# f = Facenet(mode="predict").eval()
# img = torch.randn((1, 3, 60, 60))
